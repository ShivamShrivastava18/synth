  ...
  theme: {
    extend: {
      colors: {
        ...
        "wash-rose":   "var(--wash-rose)",
        "wash-violet": "var(--wash-violet)",
        "wash-teal":   "var(--wash-teal)",
        "wash-blue":   "var(--wash-blue)",
        "tint-violet":   "var(--tint-violet)",
        "tint-teal":     "var(--tint-teal)",
        "tint-pgblue":   "var(--tint-pgblue)",
        "tint-fsorange": "var(--tint-fsorange)",
        "tint-ftteal":   "var(--tint-ftteal)",
      },
      fontFamily: {
